...
// Puedes usar una herramienta online como base64-image.de para convertir tu imagen.
                                        ...
                                        <div key={day} className={`border-b dark:border-gray-700 relative ${cabinIndex % 2 === 0 ? 'bg-gray-50 dark:bg-gray-900/50' : 'bg-white dark:bg-gray-800'}`}>
                                            {bookingOnThisDay && (
                                                <div 
                                                    ...
                                                    style={{backgroundColor: darkMode ? cabin.color.dark : cabin.color.light, color: darkMode ? '#fff' : '#000'}}
