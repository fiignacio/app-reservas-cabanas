...
import { Calendar, Users, DollarSign, BarChart2, Plus, Edit, Trash2, Moon, Sun, AlertCircle, CheckCircle, X, Info, ChevronLeft, ChevronRight, Lock, LockOpen, Car, Plane, ClipboardList } from 'lucide-react';
    ...
    const handleSaveBooking = async (formData, isPriceOverridden) => {
        ...
        try {
            ...
            if (editingBooking) {
                ...
                // We don't want to overwrite events when updating
